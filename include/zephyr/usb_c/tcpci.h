...
/*
 * In TCPC Rev 2.0, this bit must be set this to generate CC status alerts when
...
#define TCPC_REG_CC_STATUS_SET(term, cc1, cc2)  ((term) << 4 | ((cc2)&0x3) << 2 | ((cc1)&0x3))
#define TCPC_REG_CC_STATUS_LOOK4CONNECTION(reg)                                                    \
	((reg & TCPC_REG_CC_STATUS_LOOK4CONNECTION_MASK) >> 5)
#define TCPC_REG_CC_STATUS_TERM(reg) (((reg)&TCPC_REG_CC_STATUS_CONNECT_RESULT_MASK) >> 4)
#define TCPC_REG_CC_STATUS_CC2(reg)  (((reg)&TCPC_REG_CC_STATUS_CC2_STATE_MASK) >> 2)
...
#define TCPC_REG_MSG_HDR_INFO_PDREV(reg) (((reg)&0x6) >> 1)
...
/* TCPC Rev 1.0 receive registers */
...
/* TCPC Rev 1.0 transmit registers */
 ...
 * 11: reserved
 */
#define TCPC_REG_VBUS_VOLTAGE_SCALE(x)   (1 << (((x)&TCPC_REG_VBUS_VOLTAGE_SCALE_FACTOR) >> 10))
