...
#define DRIVER_INIT(inst)                                                                          \
	...
	static struct vbus_tcpci_data drv_data_##inst;                                             \
	DEVICE_DT_INST_DEFINE(inst, &tcpci_init, NULL, &drv_data_##inst, &drv_config_##inst,       \
			      POST_KERNEL, CONFIG_USBC_VBUS_INIT_PRIORITY, &vbus_tcpci_api);
